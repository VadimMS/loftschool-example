...
export default class FriendsFilter {
    constructor() {
        ...
        this.allFriendsDOMFilter = document.querySelector('[data-role=filter-input][data-list=all]');
        this.allFriendsDOMList = document.querySelector('[data-role=list-items][data-list=all]');
        this.bestFriendsDOMFilter = document.querySelector('[data-role=filter-input][data-list=best]');
        this.bestFriendsDOMList = document.querySelector('[data-role=list-items][data-list=best]');

        this.api = new VKAPI(7644766, 2);
